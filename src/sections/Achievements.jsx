      ...
      <div className="mt-14 grid grid-cols-1 md:grid-cols-2 gap-6">
        {achievements.map((item, index) => (
          <motion.div
            ...
            className="glassmorphism p-8 rounded-2xl border border-white/5 border-l-4 border-l-accent hover:bg-white/5 transition-all duration-300 hover:border-white/10 group relative overflow-hidden"
          >
            <div className="absolute top-0 right-0 w-32 h-32 bg-accent/5 rounded-bl-full -z-10 group-hover:scale-125 transition-transform duration-500" />
